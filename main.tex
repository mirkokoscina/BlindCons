...
Once the execution of the operations $o_{bc}$ triggered by the client $c_{bc}$ is done, the submitting peer generates the \textit{transaction proposal} message and then submit it to the endorsing peer. The transaction proposal message is defined as: ~\\
