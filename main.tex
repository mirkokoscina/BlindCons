...
recommends to use private or permissioned blockchains for storing sensitive data. Therefore, the absence of mechanisms to keep the user's privacy in a permissioned scheme is turning highly relevant.
...
We start by recalling Permissioned Blockchains, then we present a blind version of the Schnorr's signature scheme proposed by Okamoto et al. in~\cite{okamoto1992provably}.
...
performed by the same authority responsible for the enrollment process
...
Our consensus approach for permissioned ledger has an opposite aim of the permissionless replication protocol. The security of the consensus
