...
\begin{figure*}[tb]
\centering
\fbox{\begin{tikzpicture}[node distance=0.5cm,auto,>=stealth',scale=1,thick]
    %Nodes definition
    \node[scale=1] (comm) {};
    ...
    % Horizontal Lines
    %\draw (client) -- (client_ground);
    \draw [thick,dashed] ($(sp1)!0.1!(sp_ground)$) -- ($(comm1)!0.1!(comm_ground)$);
    \draw [thick,dashed] ($(sp3)!0.1!(sp_ground)$) -- ($(comm3)!0.1!(comm_ground)$);
	\draw [thick,dashed] ($(sp5)!0.1!(sp_ground)$) -- ($(comm5)!0.1!(comm_ground)$);
	\draw [thick,dashed] ($(sp7)!0.1!(sp_ground)$) -- ($(comm7)!0.1!(comm_ground)$);
